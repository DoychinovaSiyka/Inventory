...
class Product:
    def __init__(self, product_id, name, categories, unit, description, price, created=None, modified=None, status="Active"):
    ...
    def to_dict(self):
        ...
        return {"product_id": self.product_id, "name": self.name, "categories": category_ids,
                ...
                "modified": self.modified, "status": self.status  }
    ...
    def from_dict(data, category_controller=None):
        ...
        return Product(product_id=data.get("product_id"), name=data.get("name"),
                       categories=categories_list, unit=data.get("unit"), description=data.get("description", ""),
