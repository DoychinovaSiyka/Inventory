...
class Product:
    def __init__(self, product_id, name, categories, unit, description, price, supplier_id=None,
                 tags=None, created=None, modified=None, quantity=0):
    ...
    def to_dict(self):
        return {"product_id": self.product_id, "name": self.name,
                "categories": [c.category_id for c in self.categories], "unit": self.unit,
                "description": self.description, "price": self.price, "supplier_id": self.supplier_id,
                "tags": self.tags, "quantity": self.quantity, "created": self.created, "modified": self.modified}
