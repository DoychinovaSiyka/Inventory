...
# ТУК Е ПРОМЯНАТА: Извикваме правилното име на файла (graph_menu_view)
...
def main():
    ...
    product_controller = ProductController(
        product_repo, category_controller, supplier_controller, activity_log_controller
    )
    ...
    while True:
        ...
        if choice == "1":
            ...
            activity_log_controller.add_log(user.user_id, "LOGIN", f"{user.username} влезе в системата")
            ...
            activity_log_controller.add_log(user.user_id, "LOGOUT", f"{user.username} излезе от системата")
