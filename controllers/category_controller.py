...
class CategoryController:
    """Контролерът управлява категориите и координира работата
    между валидаторите, модела и хранилището.
    ...
    def update_name(self, category_id: str, new_name: str, user_id: str) -> bool:
        ...
        # Ако името е същото – няма нужда от запис
    ...
    def update_parent(self, category_id: str, parent_id: Optional[str], user_id: str) -> bool:
        ...
        # Ако родителят не се променя – няма нужда от запис
    ...
    # Връщам дървовидна структура чрез външната аналитична функция
