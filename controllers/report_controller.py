...
class ReportController:
    """ Контролер за отчети. Координира данни от други контролери и филтри, създава Report обекти и ги записва
    чрез JSONRepository. Не съдържа бизнес логика."""
    ...
    def _create_report(self, report_type: str, parameters: dict, data):
        ...
        return Report(report_type=report_type, generated_on=self._now(), parameters=parameters, data=data)
