...
# Класът MenuItem не създава сам логиката, която трябва да изпълни. Вместо това той получава външна функция чрез параметъра action. Това позволява MenuItem да бъде напълно независим от конкретната бизнес логика.
# Menu също не знае какво правят действията — то само ги извиква.
# Това е форма на Dependency Injection, при която поведението на менюто се инжектира отвън, което прави системата разширяема, модулна и лесна за поддръжка.“**